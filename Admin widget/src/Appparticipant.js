...
monday.api(`query { boards(limit:100) { id, name } }`).then(res => {
    ...
    monday.api(`query { me { id }}`).then(response => {
...
class App extends React.Component {
    ...
    clickChoice2(i) {
        this.setState({choice2: i},() => {
            ...
            monday.api(`mutation{
    create_item (board_id: ${databoardid}, group_id: "topics", item_name: "vote" , column_values  :  "{\\"status_1\\" : {\\"label\\" : \\"${this.state.choice2}\\"},\\"status\\" : {\\"label\\" : \\"${this.state.choice1}\\"},\\"people\\" : \\"${userid}\\",\\"date\\" : {\\"date\\" : \\"${today}\\"}  }"  ) {
        id
    }
}`).then(res => {
                console.log(res);
                        ...
                        <div style={{
                            ...
                            <Tooltip content="Organic: Walking or riding Bycicle">
                                <div className="monday-storybook-tooltip_icon-wrapper">
                                    <IconButton onClick={() => this.clickChoice1("Organic")} kind={IconButton.kinds.PRIMARY}
                            ...
                            <Tooltip content="Public Transport: Bus or Subway">
                                <div className="monday-storybook-tooltip_icon-wrapper">
                                    <IconButton onClick={() => this.clickChoice1("Public")} kind={IconButton.kinds.PRIMARY}
                    ...
                    <div className="scale-up">
                        ...
                        <div style={{
                            ...
                            <Tooltip content="Vegetables: <1kg C02/g">
                                <div className="monday-storybook-tooltip_icon-wrapper">
                                    <IconButton onClick={() => this.clickChoice2("Vegetables")} kind={IconButton.kinds.PRIMARY}
                                                ariaLabel="My primary IconButton" size={IconButton.sizes.LARGE}
                                                color={IconButton.colors.POSITIVE}
                                                className={'greenify-btn'}>
                            ...
                            <Tooltip content="Chicken/Pig/Fish: 6kg C02/g">
                                <div className="monday-storybook-tooltip_icon-wrapper">
                                    <IconButton onClick={() => this.clickChoice2("Chicken/Pork")} kind={IconButton.kinds.PRIMARY}
                                                className={"yellow-btn greenify-btn"}
                                                ariaLabel="My secondary IconButton" size={IconButton.sizes.LARGE}>
                            ...
                            <Tooltip content="Beef: >60kg C02/g">
                                <div className="monday-storybook-tooltip_icon-wrapper">
                                    <IconButton onClick={() => this.clickChoice2("Beef")}
                                                className={" greenify-btn"}
                                                kind={IconButton.kinds.PRIMARY} ariaLabel="My tertiary IconButton"
                                                size={IconButton.sizes.LARGE} color={IconButton.colors.NEGATIVE}>
