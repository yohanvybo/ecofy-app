...
{{--        <script defer="defer" src="/static/js/main.363ddf6a.js"></script>--}}
        <link href="/static/css/main.9621290f.css" rel="stylesheet">
    ...
    <div style="background: #defadb">
<div class="panel-central" >


    <
    <div style="text-align-last: center;padding-top: 60px;">
        <img src="/images/logo.png" style="height:100px;width: 100px;text-align:center;border-radius: 16px;    box-shadow:1px 3px 6px 0px rgb(0 0 0 / 12%);">
    </div>
    <h1 class="greenify-h2 h3-what-is-ecofy" style="padding-top: 20px; ">Ecofy</h1>

    <h3 class="greenify-h2 h3-what-is-ecofy">Terms</h3>



    <p class="text-center pt-4 pb-2">AGREEMENT TO TERMS

        These Terms of Service constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and [ECOFY] (“we,” “us” or “our”), concerning your access to and use of the [ECOFY] website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”).
    ...
    <p class="text-center" style="padding-bottom:400px">You can contact at <a  href="yohan.vybo@gmail.com">yohan.vybo@gmail.com</a></p>
