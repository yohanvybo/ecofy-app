...
//         });
    ...
    visualizeScore(i) {
        ...
        this.setState({scores: i.data.scores,
            subscription: i.data.subscription
        },()=>{
        ...
        if (this.state.scores.length > 0) {
            ...
            for (let i = 0; i < length; i++) {
                ...
                if (this.state.scores[i].userid === this.state.userid) {
...
//USER
            ...
            if (totalpastuserentries === 0) {
                ...
                this.setState({userscore: Math.round((currentuserentriesscore / totalcurrentuserentries) * 7 * 10) / 10});
                ...
                this.setState({progressUser: 0 - Math.round((((currentuserentriesscore / totalcurrentuserentries) - (pastuserentriesscore / totalpastuserentries)) / (pastuserentriesscore / totalpastuserentries)) * 100)});
            ...
            this.setState({donutdata: doughnutdata},()=>{
            ...
            if (totalpastteamentries === 0) {
                ...
                this.setState({teamscore: Math.round((currentteamentriesscore / totalcurrentteamentries) * 70 * this.state.subscription.participants) / 10});
                ...
                this.setState({progressTeam: 0 - Math.round((((currentteamentriesscore / totalcurrentteamentries) - (pastteamentriesscore / totalpastteamentries)) / (pastteamentriesscore / totalpastteamentries)) * 100)});
                ...
                multiValuesUser: [
                    {
                        ...
                        value: userentries2 / totalcurrentuserentries * 100,
                        color: '#FFCE56FF'
                    }, {
                        value: 100,
                        color: 'whitesmoke'
                ...
                multiValuesTeam: [
                    {
                        ...
                        value: teamentries2 / totalcurrentteamentries * 100,
                        color: '#FFCE56FF'
                    }, {
                        value: 100,
                        color: 'whitesmoke'
            ...
            if (this.state.subscription.option2 === 2) {
                this.setState({reward: 'Prize not visible'});
            }
            this.setState({exist: true});
            ...
            if (this.state.subscription.option2 === 0) {
                this.setState({reward: 'Prize not visible'});
            }
    ...
    render() {
        return <div className="App">
            {/*<div className={` ${this.state.dark ? "dark-app-theme" : ""}`}>*/}
