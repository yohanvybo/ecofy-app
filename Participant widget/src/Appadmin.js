...
//     console.log(res);
//
//     for (const board in res.data.boards) {
//         if (board.name === "Greenify Admin Board") {
//             boardadminid = board.id;
//         }
//     }
//
//
...
//
//
//     monday.api(`query { me { id, name,is_admin } }`).then(response => {
//
//         //GET USER INFO
// admin=response.data.me.is_admin;
...
//   board_owner_ids:[32022286],
//   board_kind:private
// ) { id } }`).then(res => {
//                     console.log(res);
//                     boardadminid = res.data.create_board.id;
//                 });
//             }else{
//
//             }
            ...
            <div className={` ${this.state.dark ? "dark-app-theme" : ""}`}>
                ...
                {this.state.part === 1 &&
                    <div className="scale-up">
                        <h2> ¿How did you come to work? </h2>
                        ...
                        <div style={{
                            ...
                            <Tooltip content="Organic: Walking or riding Bycicle">
                                <div className="monday-storybook-tooltip_icon-wrapper">
                                    <IconButton onClick={() => this.clickChoice1(1)} kind={IconButton.kinds.PRIMARY}
                                                ariaLabel="My primary IconButton" size={IconButton.sizes.LARGE}
                            ...
                            <Tooltip content="Public Transport: Bus or Subway">
                                <div className="monday-storybook-tooltip_icon-wrapper">
                                    <IconButton onClick={() => this.clickChoice1(2)} kind={IconButton.kinds.PRIMARY}
                                                className={"yellow-btn greenify-btn"}
                                                ariaLabel="My secondary IconButton" size={IconButton.sizes.LARGE}>
                ...
                {this.state.part === 2 &&
                    <div className="scale-up">
                        ...
                        <div style={{
                            ...
                            <Tooltip content="Vegetables: <1kg C02/g">
                                <div className="monday-storybook-tooltip_icon-wrapper">
                                    <IconButton onClick={() => this.clickChoice2(1)} kind={IconButton.kinds.PRIMARY}
                                                ariaLabel="My primary IconButton" size={IconButton.sizes.LARGE}
                                                color={IconButton.colors.POSITIVE}
                                                className={'greenify-btn'}>
                            ...
                            <Tooltip content="Chicken/Pig/Fish: 6kg C02/g">
                                <div className="monday-storybook-tooltip_icon-wrapper">
                                    <IconButton onClick={() => this.clickChoice2(2)} kind={IconButton.kinds.PRIMARY}
                                                className={"yellow-btn greenify-btn"}
                                                ariaLabel="My secondary IconButton" size={IconButton.sizes.LARGE}>
                            ...
                            <Tooltip content="Beef: >60kg C02/g">
                                <div className="monday-storybook-tooltip_icon-wrapper">
