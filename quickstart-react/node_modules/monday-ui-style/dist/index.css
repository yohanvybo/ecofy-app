...
:root {
  ...
  --h1-font-family: Poppins, Roboto, Rubik, Noto Kufi Arabic, Noto Sans JP, sans-serif;
  ...
  --font-h2: var(--font-weight-bold) var(--font-size-h2)/var(--font-line-height-h2) var(--font-family);
  --font-h3: var(--font-weight-light) var(--font-size-h3)/var(--font-line-height-h3) var(--font-family);
  --font-h4: var(--font-weight-bold) var(--font-size-h4)/var(--font-line-height-h4) var(--font-family);
...
.hacker_theme-app-theme {
  ...
  --placeholder-color: var(--color-wolf_gray);
  --placeholder-color-with-opacity: var(--color-wolf_gray-with-opacity);
  --placeholder-on-secondary-color: var(--color-wolf_gray);
  ...
  --box-shadow-medium: 0px 6px 20px #000000;
  --box-shadow-large: 0px 15px 50px #000000;
  --box-shadow-mediun: var(--box-shadow-medium);
}
